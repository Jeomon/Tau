...
class CSSMethods:
    ...
    async def set_container_query_condition_text(self, params: setContainerQueryConditionTextParameters | None = None, session_id: str | None = None) -> setContainerQueryConditionTextReturns:
        """
    No description available for setContainerQueryConditionText.    
        Args:
            params (setContainerQueryConditionTextParameters, optional): Parameters for the setContainerQueryConditionText method.
            session_id (str, optional): Target session ID for flat protocol usage.
            
        Returns:
    setContainerQueryConditionTextReturns: The result of the setContainerQueryConditionText call.
        """
        return await self.client.send(method="CSS.setContainerQueryConditionText", params=params, session_id=session_id)
