...
CookieExemptionReason = Literal['None','UserSetting','EnterprisePolicy','StorageAccess','TopLevelStorageAccess','Scheme','SameSiteNoneCookiesInSandbox']
...
class RefreshEventDetails(TypedDict, total=True):
    ...
    refreshResult: Literal["Refreshed", "InitializedService", "Unreachable", "ServerError", "RefreshQuotaExceeded", "FatalError", "SigningQuotaExceeded", "RefreshedAsWaiter", "TransientSigningError"]
