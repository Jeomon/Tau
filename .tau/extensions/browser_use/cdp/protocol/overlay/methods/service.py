...
class OverlayMethods:
    ...
    async def set_show_display_cutout(self, params: setShowDisplayCutoutParameters | None = None, session_id: str | None = None) -> Dict[str, Any]:
        """
    Add a display cutout overlay.    
        Args:
            params (setShowDisplayCutoutParameters, optional): Parameters for the setShowDisplayCutout method.
            session_id (str, optional): Target session ID for flat protocol usage.
            
        Returns:
    Dict[str, Any]: The result of the setShowDisplayCutout call.
        """
        return await self.client.send(method="Overlay.setShowDisplayCutout", params=params, session_id=session_id)
