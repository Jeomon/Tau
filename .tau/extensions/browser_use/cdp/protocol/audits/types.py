...
class InspectorIssueDetails(TypedDict, total=False):
    ...
    emailVerificationRequestIssueDetails: NotRequired[EmailVerificationRequestIssueDetails]
IssueId = str
