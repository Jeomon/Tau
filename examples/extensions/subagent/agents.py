...
Discovery merges up to two tiers (user, project) by name, project winning.
Management actions (create/update/delete/eject/disable/enable/reset) mutate
those same markdown files directly — there is no separate database, the
