...
def WheelRight(
    ...
    """
    Simulate mouse horizontal wheel scrolling right.
    wheelTimes: int.
    interval: float.
    waitTime: float.
    """
    for _i in range(wheelTimes):
        mouse_event(MouseEventFlag.HWheel, 0, 0, 120, 0)  # WHEEL_DELTA=120
        time.sleep(interval)
    time.sleep(waitTime)
...
def WheelLeft(
    ...
    """
    Simulate mouse horizontal wheel scrolling left.
    wheelTimes: int.
    interval: float.
    waitTime: float.
    """
