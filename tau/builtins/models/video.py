...
models = [
    ...
    # Z.ai — cost is flat $/video (CogVideoX-3 $0.2, Vidu Q1 $0.4, Vidu 2 $0.2-0.4),
    # not representable as per-million-token Cost, so left at Cost() like other video models.
    Model(
        id="cogvideox-3",
        name="CogVideoX-3",
        provider="zai",
